...
import com.example.yyiwen.fastmaildemo.View.LockPatternView;
...
public class LockActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SharedPreferences preferences = getSharedPreferences(GesturePasswordActivity.LOCK,
                MODE_PRIVATE);
        String patternString = preferences.getString(GesturePasswordActivity.LOCK_KEY,
                null);
