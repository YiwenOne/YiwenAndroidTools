...
public class LockSetupActivity extends AppCompatActivity implements
        ...
        case R.id.right_btn:
            if (step == STEP_2) {
                ...
                SharedPreferences preferences = getSharedPreferences(
                        GesturePasswordActivity.LOCK, MODE_PRIVATE);
                        preferences
                        .edit()
                        .putString(GesturePasswordActivity.LOCK_KEY,LockPatternView.patternToString(choosePattern))
                        .commit();
