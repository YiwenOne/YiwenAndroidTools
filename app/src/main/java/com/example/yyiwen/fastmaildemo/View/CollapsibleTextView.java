...
public class CollapsibleTextView extends TextView {
  ...
  public CollapsibleTextView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    TypedArray attributes = context.getTheme()
        .obtainStyledAttributes(attrs, com.timqi.collapsibletextview.R.styleable.CollapsibleTextView, defStyleAttr, 0);

    mSuffixColor = attributes.getColor(com.timqi.collapsibletextview.R.styleable.CollapsibleTextView_suffixColor, 0xff0000ff);
    mCollapsedLines = attributes.getInt(com.timqi.collapsibletextview.R.styleable.CollapsibleTextView_collapsedLines, 1);
    mCollapsedText = attributes.getString(com.timqi.collapsibletextview.R.styleable.CollapsibleTextView_collapsedText);
    if (TextUtils.isEmpty(mCollapsedText)) mCollapsedText = " Show All";
    mExpandedText = attributes.getString(com.timqi.collapsibletextview.R.styleable.CollapsibleTextView_expandedText);
    if (TextUtils.isEmpty(mExpandedText)) mExpandedText = " Hide";
    mSuffixTrigger = attributes.getBoolean(com.timqi.collapsibletextview.R.styleable.CollapsibleTextView_suffixTrigger, false);
