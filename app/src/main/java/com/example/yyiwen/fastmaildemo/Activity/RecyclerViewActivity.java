...
import com.example.yyiwen.fastmaildemo.Adapter.CategoryAdapter;
import com.example.yyiwen.fastmaildemo.Bean.CategoryBean;
...
public class RecyclerViewActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private void initRecyclerView() {
        ...
        mCategoryAdapter.setOnItemClickListener(new CategoryAdapter.OnItemClickListener() {
            ...
            public void OnItemClick(View view, int position, CategoryBean categoryBean) {
                Toast.makeText(RecyclerViewActivity.this, "我是第" + position + "项", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void requestLoadMoreData(){
        ...
        if (index <= 3) {
            ...
            Toast.makeText(RecyclerViewActivity.this, "已经没有新的了", Toast.LENGTH_SHORT).show();
        }
